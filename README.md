...
git clone git@github.com:testrusau/testrusau.git                  # Склонировать себе <a href="https://github.com/testrusau/testrusau">следующий репозиторий</a> в отдельную папку
